$(document).ready(function() {
	...
	$('#SaveInput').click ( function() {
		...
		if (target_rate != null) {
			document.getElementById("message").innerHTML="target rate " + target_rate + " is set for alert.";
		} else {
			document.getElementById("message").innerHTML="Invalid or empty target rate : " + target_rate + " is set for alert.";
		}
